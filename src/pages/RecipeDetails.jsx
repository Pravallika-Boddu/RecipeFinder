...
import { fetchRecipeById, saveRecipe, unsaveRecipe, getSavedRecipeIds, rateRecipe, fetchAverageRating } from '../services/api';
  ...
  useEffect(() => {
    const loadRecipe = async () => {
      ...
      try {
        ...
        const averageRating = await fetchAverageRating(parseInt(id));
